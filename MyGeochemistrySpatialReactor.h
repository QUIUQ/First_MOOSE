 ...
 */
class MyGeochemistrySpatialReactor : public GeochemistryReactorBase
{
public:
  ...
  MyGeochemistrySpatialReactor(const InputParameters & parameters);
...
protected:
  ...
  /// Spatial kinetic mineral values
  std::vector<const VariableValue *> _kinetic_species_spatial_initial_value;
